...
[Here is a link to check the web app.](https://joachimcarvallo.shinyapps.io/pred-freq-villandry/) The web app is in french because it is meant to be used by a french user (as well as the variables names). 
