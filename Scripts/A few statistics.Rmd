...
```{r}
# Month :
ggplot(visiteurs, aes(x=Mois, y= Nb_visiteurs)) + geom_boxplot() + theme_bw() + labs(x = "Month", y = "Number of visitors")

# Day of the week :
ggplot(visiteurs, aes(x=Jour, y= Nb_visiteurs)) + geom_boxplot() + theme_bw() + labs(x = "Day of the week", y = "Number of visitors")

# Public holidays :
ggplot(visiteurs, aes(x=est_jour_ferie, y= Nb_visiteurs)) + geom_boxplot() + theme_bw() + labs(x = "Public holiday ?", y = "Number of visitors")
...
ggplot(visiteurs, aes(x= Nb_visiteurs, fill = vacances)) + geom_density(alpha=.5) + 
  theme_bw() + labs(x = "Number of visitors", y = NULL, fill = "Number of vacation zones")

# Maximum temperature :
ggplot(visiteurs, aes(x=Temp.max, y= Nb_visiteurs)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Maximum temperature of the day", y = "Number of visitors")

# Précipitations :
ggplot(visiteurs, aes(x=Precipitation+1, y= Nb_visiteurs)) + geom_point(alpha=.1) + 
  scale_x_continuous(trans = 'log2') + geom_smooth() + theme_bw() + 
  labs(x = "Precipitation (log scale)", y = "Deviation from seasonality of the number of visitors")

# Description of the weather at 1 pm :
ggplot(visiteurs, aes(x=Desc_13h, y= Nb_visiteurs)) + geom_boxplot() + theme_bw() + labs(x = "Description of the weather at 1 pm", y = "Number of visitors")

# General description of the weather :
ggplot(visiteurs, aes(x=descr_generale, y= Nb_visiteurs)) + geom_boxplot() + theme_bw() + labs(x = "General description of the weather", y = "Number of visitors")

# Weather grade :
ggplot(visiteurs, aes(x=note_temps, y= Nb_visiteurs)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Weather grade", y = "Number of visitors")

#  Deviation from seasonality day-1 :
ggplot(visiteurs, aes(x=ecart_prec_1, y= Nb_visiteurs)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Deviation from seasonality day-1", y = "Number of visitors")

#  Deviation from seasonality day-2 :
ggplot(visiteurs, aes(x=ecart_prec_2, y= Nb_visiteurs)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Deviation from seasonality day-2", y = "Number of visitors")

#  Deviation from seasonality day-3 :
ggplot(visiteurs, aes(x=ecart_prec_3, y= Nb_visiteurs)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Deviation from seasonality day-3", y = "Number of visitors")
```
...
```{r}
# Month :
ggplot(visiteurs, aes(x=Mois, y= ecart_sais)) + geom_boxplot() + theme_bw() + labs(x = "Month", y = "Deviation from seasonality of the number of visitors")

# Day of the week :
ggplot(visiteurs, aes(x=Jour, y= ecart_sais)) + geom_boxplot() + theme_bw() + labs(x = "Day of the week", y = "Deviation from seasonality of the number of visitors")

# Public holidays :
ggplot(visiteurs, aes(x=est_jour_ferie, y= ecart_sais)) + geom_boxplot() + theme_bw() + labs(x = "Public holiday ?", y = "Deviation from seasonality of the number of visitors")
...
# Holidays :
visiteurs$vacances <- as.factor(visiteurs$vacances)
ggplot(visiteurs, aes(x=vacances, y= ecart_sais)) + geom_boxplot() + theme_bw() + labs(x = "Number of vacation zones", y = "Deviation from seasonality of the number of visitors")
ggplot(visiteurs, aes(x= ecart_sais, fill = vacances)) + geom_density(alpha=.5) + 
  theme_bw() + labs(x = "Deviation from seasonality of the number of visitors", y = NULL, fill = "Number of vacation zones")

# Maximum temperature :
ggplot(visiteurs, aes(x=Temp.max, y= ecart_sais)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Maximum temperature of the day", y = "Deviation from seasonality of the number of visitors")

# Précipitations :
ggplot(visiteurs, aes(x=Precipitation+1, y= ecart_sais)) + geom_point(alpha=.1) +
  scale_x_continuous(trans = 'log10') + geom_smooth() + theme_bw() + 
  labs(x = "Precipitation (log scale)", y = "Deviation from seasonality of the number of visitors")

# Description of the weather at 1 pm :
ggplot(visiteurs, aes(x=Desc_13h, y= ecart_sais)) + geom_boxplot() + theme_bw() + labs(x = "Description of the weather at 1 pm", y = "Deviation from seasonality of the number of visitors")

# General description of the weather :
ggplot(visiteurs, aes(x=descr_generale, y= ecart_sais)) + geom_boxplot() + theme_bw() + labs(x = "General description of the weather", y = "Deviation from seasonality of the number of visitors")

# Weather grade :
ggplot(visiteurs, aes(x=note_temps, y= ecart_sais)) + geom_point(alpha=.1) + 
  geom_smooth() + theme_bw() + labs(x = "Weather grade", y = "Deviation from seasonality of the number of visitors")
```
